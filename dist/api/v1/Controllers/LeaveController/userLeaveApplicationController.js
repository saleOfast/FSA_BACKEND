...
const userLeaveApplication_entity_1 = require("../../../../core/DB/Entities/userLeaveApplication.entity");
...
class LeaveApplicationController {
    constructor() {
        this.leaveApplicationRepository = (0, userLeaveApplication_entity_1.LeaveApplicationRepository)();
    ...
    createUserLeaveApplication(input, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.leaveApplicationRepository.save(newLeaveAppl);
                // const headLeaveCountData = await this.leaveCountRepository.findByPk(head_leave_cnt_id);
                const userLeaveData = yield this.userLeaveRepository.findOne({
                    where: {
                ...
                if (!userLeaveData) {
                    const headLeaveCountData = yield this.leaveCountRepository.findOne({
                        where: { headLeaveCntId: Number(head_leave_cnt_id) }
                    });
                    yield this.userLeaveRepository.save({
                    ...
                    yield this.userLeaveRepository.update({ user_id: emp_id, head_leave_cnt_id: Number(head_leave_cnt_id) }, // WHERE condition
    ...
    //     }
    // }
    getLeaveApplication(payload, input) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    updateLeaveApplication(input, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const data = yield this.leaveApplicationRepository.findOne({ where: { leave_app_id } });
                if (!data)
                    return { status: common_1.STATUSCODES.NOT_FOUND, message: "No data found with this leave id" };
                yield this.leaveApplicationRepository.update({ leave_app_id }, { remarks, leave_app_status });
                return { message: "Leave Application Updated Successfully", status: common_1.STATUSCODES.SUCCESS, data: data };
            }
            catch (error) {
                throw error;
            }
    ...
    deleteLeaveApplication(input, payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { leave_app_id } = input;
                if (!leave_app_id)
                    return { status: common_1.STATUSCODES.BAD_REQUEST, message: "Leave Id is required." };
                const data = yield this.leaveApplicationRepository.findOne({ where: { leave_app_id: Number(leave_app_id) } });
                if (!data)
                    return { status: common_1.STATUSCODES.NOT_FOUND, message: "No data found with this leave Application id" };
                yield this.leaveApplicationRepository.softDelete({ leave_app_id: Number(leave_app_id) });
