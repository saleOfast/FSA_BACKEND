...
exports.EDetailingRouter = void 0;
...
const EDetailing_Controller_1 = require("../../../../api/v1/Controllers/EDetailingController/EDetailing.Controller");
// import { DarController } from "api/v1/Controllers/DarController/Dar.Controller";
const router = express_1.default.Router();
exports.EDetailingRouter = router;
router.post('/add', validationMiddleware_1.AccessTokenService.validateTokenMiddleware(common_1.JwtTokenTypes.AUTH_TOKEN), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const services = new EDetailing_Controller_1.EDetainingController();
        const data = yield services.createEDetailing(input);
...
router.get('/get', validationMiddleware_1.AccessTokenService.validateTokenMiddleware(common_1.JwtTokenTypes.AUTH_TOKEN), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const services = new EDetailing_Controller_1.EDetainingController();
        const data = yield services.getEDetailing(input);
        validationMiddleware_1.ResponseHandler.sendResponse(res, data);
    }
    catch (error) {
        validationMiddleware_1.ResponseHandler.sendErrorResponse(res, error);
...
router.get('/getById/:e_detailing_id', validationMiddleware_1.AccessTokenService.validateTokenMiddleware(common_1.JwtTokenTypes.AUTH_TOKEN), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const input = RequestHander_1.RequestHandler.Defaults.getParams(req);
        const services = new EDetailing_Controller_1.EDetainingController();
        const data = yield services.getEDetailingById(input);
        validationMiddleware_1.ResponseHandler.sendResponse(res, data);
    }
    catch (error) {
        validationMiddleware_1.ResponseHandler.sendErrorResponse(res, error);
...
router.put('/update', validationMiddleware_1.AccessTokenService.validateTokenMiddleware(common_1.JwtTokenTypes.AUTH_TOKEN), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const payload = RequestHander_1.RequestHandler.Custom.getUser(req);
        const services = new EDetailing_Controller_1.EDetainingController();
        const data = yield services.editEDetailing(input);
        validationMiddleware_1.ResponseHandler.sendResponse(res, data);
    }
    catch (error) {
        validationMiddleware_1.ResponseHandler.sendErrorResponse(res, error);
...
router.delete('/delete/:e_detailing_id', validationMiddleware_1.AccessTokenService.validateTokenMiddleware(common_1.JwtTokenTypes.AUTH_TOKEN), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const input = RequestHander_1.RequestHandler.Defaults.getParams(req, DarService_1.DarD);
        const services = new EDetailing_Controller_1.EDetainingController();
        const data = yield services.deleteEDetailing(input);
        validationMiddleware_1.ResponseHandler.sendResponse(res, data);
    }
    catch (error) {
        validationMiddleware_1.ResponseHandler.sendErrorResponse(res, error);
