...
exports.ReasonRepository = exports.Reason = void 0;
const typeorm_1 = require("typeorm");
const postgresdb_1 = require("../postgresdb");
let Reason = class Reason extends typeorm_1.BaseEntity {
};
__decorate([
    (0, typeorm_1.PrimaryGeneratedColumn)({ name: 'reason_id' }),
    __metadata("design:type", Number)
], Reason.prototype, "reasonId", void 0);
__decorate([
    (0, typeorm_1.Column)({ name: 'emp_id' }),
    __metadata("design:type", Number)
], Reason.prototype, "empId", void 0);
__decorate([
...
const ReasonRepository = () => {
    return postgresdb_1.DbConnections.AppDbConnection.getConnection().getRepository(Reason);
};
